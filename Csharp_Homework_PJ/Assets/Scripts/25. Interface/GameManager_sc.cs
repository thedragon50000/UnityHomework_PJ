                ...
                foreach (KeyCode keyCode in Enum.GetValues(typeof(KeyCode)))
                {
                    if (Input.GetKeyDown(keyCode))
                    {
                        switch (keyCode)
                        {
                            ...
                            case KeyCode.R:
                                print("Press R.");
                                if (_animal.Actions.Length < 4)
                                {
                                    // print(eAnimals + " Idle.");
                                }
                                else _animal.Actions[3].Invoke();
